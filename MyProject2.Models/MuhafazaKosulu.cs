...
{
    public class MuhafazaKosulu : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        private int _MuhafazaKosuluID { get; set; }
        private string? _Tanim { get; set; }
        private bool _Silindi { get; set; }



        public int MuhafazaKosuluID
        {
            get => _MuhafazaKosuluID;
            set { _MuhafazaKosuluID = value; OnChanged(nameof(MuhafazaKosuluID)); }
        }
        public string? Tanim
        {
            get => _Tanim;
